...
class BARTAACTrainer(Trainer):
    ...
    def _save(self, output_dir=None, state_dict=None):
        ...
        self.save_model(output_dir)  # Save the model using PyTorch save
    ...
    def save_model(self, output_dir, _internal_call=False):
        ...
        torch.save(self.model.state_dict(), output_dir+'.bin')
    ####### custom end ###############
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if hasattr(model, 'module'):
            if hasattr(model.module, 'freeze_audio_enc') and model.module.freeze_audio_enc:
                model.module.audio_enc.eval()
        else:
            if hasattr(model, 'freeze_audio_enc') and model.freeze_audio_enc:
